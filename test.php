...
<body>
    ...
    <header>
        ...
        <p>Inside the source of this file, you can un-comment and test 2 different types of forms:
            <div class="indent">
                <ul>
	...
	<?php
        /* Below are 2 different forms to be re-used. Only use one at a time, comment out the other! */
